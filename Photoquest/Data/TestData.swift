...
struct TestData {
    static let bananaPhoto = Photo(name: "Banana", acceptedIdentifiers: [], image: UIImage(named: "banana"), capturedDate: Date.now)
    ...
    static let blackberryPhoto = Photo(name: "Blackberry", acceptedIdentifiers: [], image: UIImage(named: "blackberry"), capturedDate: Date.now)
